...
#         Examples of CORRECT rows
#         {
#         f'  "ride_id": "BBC291376E29C9A1",'
#         f'  "rideable_type": "classic_bike",'
#         f'  "start_at": "2024-01-19 20:24:21",'
#         f'  "end_at": "2024-01-19 20:34:26",'
#         f'  "start_station_name": "Florida Ave & R St NW",'
#         f'  "start_station_id": "31503",'
#         f'  "end_station_name": "11th & M St NW",'
#         f'  "end_station_id": "31266",'
#         f'  "start_lat": 38.9126,'
#         f'  "start_lng": -77.0135,'
#         f'  "end_lat": 38.9055785,'
#         f'  "end_lng": -77.027313,'
#         f'  "member_casual": "member"'
#         }

#         {
#         f'  "ride_id": "DE01351AA3EE520A",'
#         f'  "rideable_type": "electric_bike",'
#         f'  "start_at": "2024-01-24 06:01:16",'
#         f'  "end_at": "2024-01-24 06:14:36",'
#         f'  "start_station_name": "11th & Park Rd NW",'
#         f'  "start_station_id": "31651",'
#         f'  "end_station_name": "18th & L St NW",'
#         f'  "end_station_id": "31224",'
#         f'  "start_lat": 38.931365132,'
#         f'  "start_lng": -77.028289914,'
#         f'  "end_lat": 38.903741450919384,'
#         f'  "end_lng": -77.04245209693909,'
#         f'  "member_casual": "casual"'
#         }


#         Examples of INCORRECT rows
#         {
#         f'  "ride_id": "624EA0EBB92C5CD9",'
#         f'  "rideable_type": "electric bike",'
#         f'  "start_at": "2024-01-10 161307",'
#         f'  "end_at": "2024-01-10 16:17:08",'
#         f'  "start_station_name": "Virginia Square Metro / Monroe St & 9th St N",'
#         f'  "start_station_id": "31024",'
#         f'  "end_station_name": "Washington Blvd & 10th St N",'
#         f'  "end_station_id": "31026",'
#         f'  "start_lat": 38.882723927,'
#         f'  "start_lng": -77.103165865,'
#         f'  "end_lat": 38.884734,'
#         f'  "end_lng": -77.093485,'
#         f'  "member_casual": "membr"'
#         }

#         {
#         f'  "ride_id": "E6 03 F5 19 B0 8C D1 A5",'
#         f'  "rideable_type": "classic_bike",'
#         f'  "start_at": "2024-01-30 14:08:31",'
#         f'  "end_at": "2024-01-30 14:11:53",'
#         f'  "start_station_name": "4th  &  E  St  SW",'
#         f'  "start_station_id": "31244",'
#         f'  "end_station_name": "4th & M St SW",'
#         f'  "end_station_id": "31108",'
#         f'  "start_lat": ,'
#         f'  "start_lng": ,'
#         f'  "end_lat": 38.87682269362587,'
#         f'  "end_lng": -77.01777443289757,'
#         f'  "member_casual": "causual"'
#         }

#         Return the cleaned row in JSON format.
#     """
#     return prompt
