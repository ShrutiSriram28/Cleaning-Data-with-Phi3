...
| start_station_name | Name of the station where the ride starts |
| start_station_id | ID of the station where the ride starts |
| end_station_name | Name of the station where the ride ends |
| end_station_id | ID of the station where the ride ends |
| start_lat | Latitude of the station where the ride starts |
| start_lng | Longitude of the station where the ride starts |
| end_lat | Latitude of the station where the ride ends |
| end_lng | Longitude of the station where the ride ends |
